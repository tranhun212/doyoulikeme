    ...
    <>
      <div className="relative w-full h-full flex justify-center">
        <img
          ...
          className="w-[90vh] h-auto absolute z-0 left-0 top-14"
          alt=""
        />
        <img
          src="https://iili.io/Fh9dtXR.png"
          className="w-[90vh] h-auto absolute z-0 right-0 top-14"
          alt=""
        />
        {!accpeted ? (
          <div className="w-[80vh] h-[60vh] bg-sky-100 border-4 border-sky-950 rounded-3xl shadow-2xl flex flex-col items-center py-5 gap-5 absolute top-36 ">
          ...
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            className="text-center p-6 rounded-xl shadow-xl bg-gray-300 mt-8"
          >
